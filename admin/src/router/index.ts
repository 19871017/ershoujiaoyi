...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/login', component: () => import('../pages/login/index.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'chat-trace', component: () => import('../pages/chat-trace/index.vue') },
      { path: 'chat-trace/:conversationId', component: () => import('../pages/chat-trace/index.vue') },
      { path: 'community-trace', component: () => import('../pages/community-trace/index.vue') },
      { path: 'community-trace/:postId', component: () => import('../pages/community-trace/index.vue') },
