...
const requiredPatterns = [
  ...
  { file: 'src/pages/audit/report-handling.ts', pattern: /没有独立私聊追溯页/, message: 'report handling guide must fail closed for chat reports until a real chat trace page exists' },
