  ...
  <view class="page-shell after-detail-page">
    ...
    <template v-else-if="detail">
      ...
      <view class="info-card ds-card">
        ...
        <view class="evidence-row"><view v-for="img in detail.evidenceUrls" :key="img" class="image-chip">凭证</view></view>
      </view>
      ...
      <view class="action-card ds-card">
        ...
        <button class="primary-btn" @click="addEvidence">补充凭证</button>
      </view>
    </template>
  </view>
</template>
