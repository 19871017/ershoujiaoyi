...
<style scoped>
.method-page{background:linear-gradient(180deg,#fff7ed 0%,#fffdfa 55%,#fff7ed 100%)}.hero,.status-card,.steps-card,.order-card{margin-top:12rpx;padding:16rpx;border-color:#ffd9bd}.hero{display:flex;justify-content:space-between;align-items:center;background:linear-gradient(135deg,#fff,#fff3e7)}.kicker{color:#ff7a45;font-size:20rpx;font-weight:950}.hero-icon{width:62rpx;height:62rpx;border-radius:22rpx;background:#3a2a1f;color:#fff;display:flex;align-items:center;justify-content:center;font-size:28rpx}.section-title{color:#3a2a1f;font-size:25rpx;font-weight:950}.danger{border-color:#fecaca;background:#fff7f7}.status-line{margin-top:8rpx;color:#ef4444;font-size:22rpx;font-weight:950}.desc,.step,.info-row{margin-top:8rpx;color:#7b5542;font-size:21rpx;line-height:1.35}.step{padding:10rpx;border-radius:16rpx;background:#fffaf6;border:1rpx solid #ffd9bd}.info-row{display:flex;justify-content:space-between;gap:10rpx}.info-row text:last-child{color:#3a2a1f;font-weight:900;text-align:right}.primary-btn{margin-top:14rpx}
</style>
