    ...
    <view v-else class="product-list">
      <view v-for="item in filtered" :key="item.productNo || item.productId" class="product-card ds-card">
        ...
        <view class="main">
          ...
          <view class="price">底价 ¥{{ sellerDisplayPrice(item) }}</view>
          <view v-if="item.sellerPrice && item.price !== item.sellerPrice" class="buyer-price">买家展示 ¥{{ item.price }}</view>
          <view class="actions">
...
function sellerDisplayPrice(item: ProductListItemResponse) { return item.sellerPrice || item.price }
