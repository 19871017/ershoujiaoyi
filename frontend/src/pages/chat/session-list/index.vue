...
function countByFilter(value: Filter) {
...
function scenarioLabel(summary?: string) {
  if (!summary) return ''
...
.session-meta { margin-top:8rpx; display:flex; gap:12rpx; color:#b9856a; font-size:19rpx; align-items:center; flex-wrap:wrap; }
.scenario-chip { padding:6rpx 12rpx; border-radius:999rpx; background:#fff3e7; color:#ff7a45; font-weight:900; }
