...
.ranking-art { position:absolute; left:0; right:0; top:0; bottom:0; background-repeat:no-repeat; background-size:cover; background-position:center top; transform:translateY(18rpx) scale(1.08); transform-origin:top center; }
.ranking-goddess .ranking-art { background-position:center top; }
.ranking-god .ranking-art { background-position:center top; }
