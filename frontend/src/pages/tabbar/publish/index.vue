  ...
  <view class="page-shell seller-page">
    <view class="goddess-top ds-card">
      ...
      <view class="goddess-head">
        <view class="head-copy">
          ...
          <view class="goddess-label">女神榜前三</view>
        </view>
    ...
    <view class="spotlight-row">
      <view v-for="item in spotlightMerchants" :key="`spot-${item.id}`" class="spotlight-card ds-card tapable" @click="openProfile(item)">
        ...
        <view class="spotlight-score">{{ item.giftScore }}</view>
      </view>
    </view>
...
function isCertifiedMerchant(item: UserRankingResponse) {
  return isSellerRole(String(item.mainRole || '').toUpperCase())
}
...
.goddess-top{position:relative;overflow:hidden;margin-top:18rpx;padding:26rpx 22rpx 28rpx;border-color:#ffd6c9;background:linear-gradient(135deg,#fff7fb 0%,#ffeef4 46%,#fff4e6 100%);box-shadow:0 24rpx 58rpx rgba(255,91,145,.13)}
.goddess-bg{position:absolute;right:-42rpx;top:-56rpx;width:310rpx;height:310rpx;border-radius:50%;background:radial-gradient(circle at 35% 32%,rgba(255,255,255,.9),rgba(255,179,203,.35) 38%,rgba(255,122,69,.16) 64%,rgba(255,122,69,0) 74%)}
...
.podium-item{position:relative;min-height:192rpx;padding:18rpx 10rpx 16rpx;border-radius:32rpx;background:rgba(255,255,255,.76);border:1rpx solid rgba(255,255,255,.82);display:flex;flex-direction:column;align-items:center;box-shadow:0 16rpx 34rpx rgba(111,78,55,.09);backdrop-filter:blur(12rpx)}
.podium-item.rank-1{min-height:220rpx;background:linear-gradient(180deg,rgba(255,255,255,.88) 0%,rgba(255,238,211,.82) 100%);box-shadow:0 22rpx 44rpx rgba(255,122,69,.18)}
.crown{font-size:30rpx;line-height:1}
.podium-avatar{margin-top:8rpx;width:78rpx;height:78rpx;border-radius:50%;background:linear-gradient(135deg,#ff8aa8,#ffbe6e);color:#fff;display:flex;align-items:center;justify-content:center;font-size:34rpx;font-weight:950;border:5rpx solid rgba(255,255,255,.86);box-shadow:0 12rpx 24rpx rgba(255,91,145,.22);overflow:hidden}
...
.spotlight-card{padding:16rpx;border-color:#ffd9bd;background:linear-gradient(135deg,#fff,#fff4ea);display:flex;align-items:center;gap:12rpx;box-shadow:0 16rpx 32rpx rgba(255,122,69,.08)}
...
.spotlight-score{flex:0 0 auto;color:#ff3f8d;font-size:26rpx;font-weight:950}
...
.merchant-cover{height:156rpx;border-radius:30rpx;background:linear-gradient(135deg,#fff0f6 0%,#ffe1cd 52%,#fff8ed 100%);display:flex;align-items:center;justify-content:center;position:relative;overflow:hidden}
...
.merchant-avatar{position:relative;z-index:1;width:96rpx;height:96rpx;border-radius:50%;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#ff7a9d 0%,#ffb15d 100%);color:#fff;font-size:40rpx;font-weight:950;border:6rpx solid rgba(255,255,255,.86);box-shadow:0 16rpx 32rpx rgba(255,91,145,.2);overflow:hidden}
...
.merchant-name{margin-top:14rpx;color:#3a2a1f;font-size:26rpx;font-weight:950;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
