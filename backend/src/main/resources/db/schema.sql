...
CREATE INDEX IF NOT EXISTS idx_user_no_change_log_new_no ON user_no_change_log(new_user_no);
...
CREATE INDEX IF NOT EXISTS idx_user_login_record_user ON user_login_record(user_id, login_at);
...
CREATE INDEX IF NOT EXISTS idx_user_address_user_default ON user_address(user_id, is_default, updated_at);
...
CREATE TABLE IF NOT EXISTS trade_order (
  ...
  seller_amount DECIMAL(18,2) NOT NULL DEFAULT 0.00,
  platform_markup_rate DECIMAL(8,4) NOT NULL DEFAULT 0.0000,
  platform_markup_amount DECIMAL(18,2) NOT NULL DEFAULT 0.00,
...
CREATE INDEX IF NOT EXISTS idx_community_post_status_created_id ON community_post(status, created_at, id);
CREATE INDEX IF NOT EXISTS idx_community_post_status_topic_created_id ON community_post(status, topic, created_at, id);
